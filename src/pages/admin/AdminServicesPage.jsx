    ...
    <div>
      <div className="admin-card">
        <div className="admin-card-header">
          <div>
            ...
            <p style={{ fontSize: "0.88rem", color: "var(--color-text-secondary)", marginTop: "2px" }}>
              Servicios disponibles para agendar en línea en GLAMUROSA NAIL’S con tiempos y precios estimados.
            </p>
          </div>
                  ...
                  <td>
                    <div>
                      ...
                      <div style={{ fontSize: "0.72rem", color: "var(--color-text-muted)" }}>
                        Anticipo: ${service.suggestedDeposit || 100} MXN
                      </div>
                    </div>
                  </td>
                  <td>
        ...
        <div style={{ marginTop: "1.5rem", padding: "1rem", backgroundColor: "var(--color-bg)", borderRadius: "10px", border: "1px dashed var(--border-light)", fontSize: "0.84rem", color: "var(--color-text-secondary)" }}>
          ✨ <strong>Nota comercial demostrativa:</strong> En la propuesta final para GLAMUROSA NAIL’S, el catálogo se adapta al menú oficial de servicios, duración real por técnica y precios del studio.
        </div>
      </div>
    </div>
  );
