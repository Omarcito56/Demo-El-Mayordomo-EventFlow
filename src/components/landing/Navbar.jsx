...
import { MayordomoLogoIcon, MenuIcon, XIcon, ArrowRightIcon, CalendarIcon } from "../common/Icons";
      ...
      <div className="container navbar-container">
        ...
        <Link to="/" className="navbar-brand">
          <div className="navbar-brand-emblem">
            <MayordomoLogoIcon size={24} />
          </div>
          <div className="navbar-brand-text">
            <span className="navbar-brand-title">El Mayordomo</span>
            <span className="navbar-brand-subtitle">Banquetes & Catering</span>
          </div>
        </Link>
